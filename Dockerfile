...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends php7.2-fpm php7.2-cli php7.2-gd php7.2-curl php7.2-mbstring php7.2-soap php7.2-xmlrpc php7.2-zip php7.2-mysql php7.2-sqlite3
